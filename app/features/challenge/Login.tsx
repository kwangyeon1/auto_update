  ...
  return (
    <div className="tab-pane" id="step1">
			<div className="button-wrapper">
				<p className="nsk" style={{fontSize: "20px", textAlign: "left",     marginBottom: "30px"}}>챌린지 시작하기</p>
				<p className="nsk" style={{fontSize: "20px",  textAlign: "left", marginLeft: "20px"}}>챌린지 인증 서비스입니다</p>
